...
* Navigate to the project folder and type `npm install package.json` to install the required dependencies.
...
* This app uses [Materialize](http://materializecss.com) for styling.
